 ...
 * Generated at: 2018-07-13 12:33:56 UTC
...
public final class item_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div class=\"dd\">由 Newstyles 发货并提供售后服务。</div>\r\n");
      out.write("\t</li>\r\n");
      ...
      out.write("\t\t<dt>Newstyles·正品保证</dt>\r\n");
      ...
      out.write("\tNewstyles向您保证所售商品均为正品行货，Newstyles自营商品开具机打发票或电子发票。凭质保证书及Newstyles发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由Newstyles联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。Newstyles还为您提供具有竞争力的商品价格和<a href=\"http://www.jd.com/help/kdexpress.aspx\" target=\"_blank\">运费政策</a>，请您放心购买！\r\n");
      out.write("\t<br /><br />\r\n");
      ...
      out.write("\t<strong>权利声明：</strong><br />Newstyles上的所有商品信息、客户评价、商品咨询、网友讨论等内容，是Newstyles重要的经营资源，未经许可，禁止非法转载使用。\r\n");
